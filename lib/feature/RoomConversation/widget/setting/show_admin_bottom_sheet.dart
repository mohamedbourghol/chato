...
Future<String?> showAdminBottomSheet(BuildContext ctx,
            ...
            child: Column(
              children: [
                ...
                Expanded(
                              ...
                              children: [
                                Stack(
                                  ...
                                  children: [
                                    ...
                                    if(state.allTypeAdmin.data![index].vip_user!=null)
                                      SizedBox(
                                        width:state.allTypeAdmin.data![index].vip_user!.vip_id
                                            =="1"?64.h: 75.h,
                                        height: state.allTypeAdmin.data![index].vip_user!.vip_id
                                            =="1"?64.h: 75.h,
                                        child:Image.asset(
                                          state.allTypeAdmin.data![index].vip_user!.vip_id
                                              =="1"?
                                ...
                                SizedBox(width: 6.w,),
                                Expanded(
                                  child: Text(state.allTypeAdmin.data![index].name!,
                                    style: TextStyle(
                                        fontSize: 15.sp,
                                        fontFamily: 'Roboto',
                                        fontWeight: FontWeight.w600,
                                ...
                                IconButton(onPressed: (){
                                  bloc.onChangePermeationUserEvent(
                                      roomId,
                                      state.allTypeAdmin.data![index].id!,
                                      'user');

                                  state.allTypeAdmin.data!.removeAt(index);
                                  Future.delayed(const Duration(milliseconds: 500)).then((value) {
                                    bloc.onGetAllTypeEvent('user', roomId);
                                  });
                  ...
                  state.allTypeAdmin.data!=null?
                  state.allTypeAdmin.data!.length:0
                  ),
                ),
                Divider(
                  thickness:1,
