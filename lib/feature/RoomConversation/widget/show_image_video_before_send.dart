...
class ShowImageVideoBeforeSend extends StatefulWidget {
   final  File file;
   final RoomConversationBloc bloc;
   final int roomId;
  const ShowImageVideoBeforeSend({Key? key,
   required this.file,
    required this.bloc,
  ...
  @override
  _ShowImageVideoBeforeSendState createState() => _ShowImageVideoBeforeSendState();
}

class _ShowImageVideoBeforeSendState extends State<ShowImageVideoBeforeSend> {
